...
public class MHS_GaleriAdapter extends RecyclerView.Adapter<MHS_GaleriAdapter.MHS_GaleriViewHolder> {
    ...
    public MHS_GaleriAdapter(ArrayList<GaleriModel> galeriList, Context context) {
        this.galeriList = galeriList;
        this.context = context;
    }

    @Override
    public MHS_GaleriViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.single_view_row_galeri,parent,false);
        return new  MHS_GaleriViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MHS_GaleriViewHolder holder, int position) {
...
//        holder.gambar.setImageBitmap(decodeImage);
    ...
    class MHS_GaleriViewHolder extends RecyclerView.ViewHolder{

        TextView txtId, txtJudul;
        ImageView gambar;

        MHS_GaleriViewHolder(View itemView) {
            super(itemView);
