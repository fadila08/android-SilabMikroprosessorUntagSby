...
import untag.daskom.myapplication.activity.laboran.LABORANEditUnduhan;
import untag.daskom.myapplication.activity.laboran.LABORANHomeUnduhan;
...
public class LABORAN_UnduhanAdapter extends RecyclerView.Adapter<LABORAN_UnduhanAdapter.LABORAN_UnduhanViewHolder> {
    ...
    public LABORAN_UnduhanAdapter(ArrayList<UnduhanModel> unduhanList, Context context) {
        this.unduhanList = unduhanList;
        this.context = context;
    }

    @Override
    public LABORAN_UnduhanViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.single_view_row_unduhan_auth,parent,false);
        return new LABORAN_UnduhanViewHolder(view);
    }

    @Override
    public void onBindViewHolder(LABORAN_UnduhanViewHolder holder, int position) {
    ...
    class LABORAN_UnduhanViewHolder extends RecyclerView.ViewHolder {

        TextView txtJudul, txtCreatedAt, txtKeterangan, txtId, txtBatasBerlaku;
        Button btnEdit, btnHapus;

        public LABORAN_UnduhanViewHolder(View itemView) {
            super(itemView);
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(v.getContext(), LABORANEditUnduhan.class);
...
//                                                    Log.d("message",message);
                                            ...
                                            Intent intent = new Intent(context, LABORANHomeUnduhan.class);
