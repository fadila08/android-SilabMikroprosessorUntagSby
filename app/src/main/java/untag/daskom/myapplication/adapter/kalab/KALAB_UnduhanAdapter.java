...
import untag.daskom.myapplication.activity.kalab.KALABEditUnduhan;
import untag.daskom.myapplication.activity.kalab.KALABHomeUnduhan;
...
public class KALAB_UnduhanAdapter extends RecyclerView.Adapter<KALAB_UnduhanAdapter.KALAB_UnduhanViewHolder> {
    ...
    public KALAB_UnduhanAdapter(ArrayList<UnduhanModel> unduhanList, Context context) {
        this.unduhanList = unduhanList;
        this.context = context;
    }

    @Override
    public KALAB_UnduhanViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.single_view_row_unduhan_auth,parent,false);
        return new KALAB_UnduhanViewHolder(view);
    }

    @Override
    public void onBindViewHolder(KALAB_UnduhanViewHolder holder, int position) {
    ...
    class KALAB_UnduhanViewHolder extends RecyclerView.ViewHolder {

        TextView txtJudul, txtCreatedAt, txtKeterangan, txtId, txtBatasBerlaku;
        Button btnEdit, btnHapus;

        public KALAB_UnduhanViewHolder(View itemView) {
            super(itemView);
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(v.getContext(), KALABEditUnduhan.class);
...
//                                                    Log.d("message",message);
                                            ...
                                            Intent intent = new Intent(context, KALABHomeUnduhan.class);
