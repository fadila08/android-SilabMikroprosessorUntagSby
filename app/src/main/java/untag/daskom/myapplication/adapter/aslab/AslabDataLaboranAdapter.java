...
public class AslabDataLaboranAdapter extends RecyclerView.Adapter<AslabDataLaboranAdapter.AslabDataLaboranViewHolder>{
    ...
    public AslabDataLaboranAdapter(ArrayList<DataUser> dataList, Context context) {
        this.dataList = dataList;
        this.context = context;
    }

    @Override
    public AslabDataLaboranViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.single_view_row_data_laboran_aslab, parent, false);
        return new AslabDataLaboranViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AslabDataLaboranViewHolder holder, int position) {
    ...
    class AslabDataLaboranViewHolder extends RecyclerView.ViewHolder {

        TextView txtNama, txtNomorInduk, txtId, txtPopupNama, txtPopupNInduk, txtPopupWa, txtPopupEmail;

        AslabDataLaboranViewHolder(View itemView) {
            super(itemView);
            txtNama = itemView.findViewById(R.id.txt_nama_laboran_aslab);
            txtNomorInduk = itemView.findViewById(R.id.txt_nomor_induk_laboran_aslab);
            txtId = itemView.findViewById(R.id.txt_id_laboran_aslab);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    txtPopupNama = popupDialog.findViewById(R.id.txt_detail_nama_laboran_aslab);
                    txtPopupNInduk = popupDialog.findViewById(R.id.txt_detail_nip_laboran_aslab);
                    txtPopupWa = popupDialog.findViewById(R.id.txt_detail_no_wa_laboran_aslab);
                    txtPopupEmail = popupDialog.findViewById(R.id.txt_detail_email_laboran_aslab);
                    ...
                    Call<UserDetailList> call = service.getLaboranDetailDataAslab("Bearer "+session, selectId);
