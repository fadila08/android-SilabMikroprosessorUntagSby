...
import untag.daskom.myapplication.activity.kalab.KALABHomeGaleri;
...
public class KALAB_GaleriAdapter extends RecyclerView.Adapter<KALAB_GaleriAdapter.KALAB_GaleriViewHolder> {
    ...
    public KALAB_GaleriAdapter(ArrayList<GaleriModel> galeriList, Context context) {
        this.galeriList = galeriList;
        this.context = context;
    }

    @Override
    public KALAB_GaleriViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.single_view_row_galeri_auth,parent,false);
        return new  KALAB_GaleriViewHolder(view);
    }

    @Override
    public void onBindViewHolder(KALAB_GaleriViewHolder holder, int position) {
...
//        holder.gambar.setImageBitmap(decodeImage);
    ...
    class KALAB_GaleriViewHolder extends RecyclerView.ViewHolder{

        TextView txtId, txtJudul;
        ImageView gambar, hapus;

        KALAB_GaleriViewHolder(View itemView) {
            super(itemView);
...
//                                                    Log.d("message",message);
                                            ...
                                            Intent intent = new Intent(context, KALABHomeGaleri.class);
