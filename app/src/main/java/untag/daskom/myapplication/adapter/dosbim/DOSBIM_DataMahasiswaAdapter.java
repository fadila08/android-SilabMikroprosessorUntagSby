...
public class DOSBIM_DataMahasiswaAdapter extends RecyclerView.Adapter<DOSBIM_DataMahasiswaAdapter.DataMahasiswaViewHolder>  {
    ...
    public DOSBIM_DataMahasiswaAdapter(List<DataMahasiswa> dataList, Context context) {
    ...
    class DataMahasiswaViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtNama, txtNomorInduk, txtId, txtPopupId, txtPopupNama, txtPopupNbi, txtPopupPraktikum, txtPopupKelas, txtPopupThnPel, txtPopupSemester, txtPopupWa, txtPopupEmail;
        ...
        DataMahasiswaViewHolder(View itemView) {
            ...
            txtId = itemView.findViewById(R.id.txt_id_mahasiswa_dosbim);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    popupDialog.setContentView(R.layout.dosbim_data_mhs_popup);

                    txtPopupNama = popupDialog.findViewById(R.id.txt_detail_nama_mhs_on_dosbim);
                    txtPopupNbi = popupDialog.findViewById(R.id.txt_detail_nbi_mhs_dosbim);
                    txtPopupPraktikum = popupDialog.findViewById(R.id.txt_detail_praktikum_mhs_dosbim);
                    txtPopupSemester = popupDialog.findViewById(R.id.txt_detail_sem_mhs_dosbim);
                    txtPopupThnPel = popupDialog.findViewById(R.id.txt_detail_thnPel_mhs_dosbim);
                    txtPopupKelas = popupDialog.findViewById(R.id.txt_detail_kelas_mhs_dosbim);
                    txtPopupEmail = popupDialog.findViewById(R.id.txt_detail_email_mhs_dosbim);
                    txtPopupWa = popupDialog.findViewById(R.id.txt_detail_no_wa_mhs_dosbim);
                    txtPopupId = popupDialog.findViewById(R.id.txt_detail_id_mhs_dosbim);
                    ...
                    call.enqueue(new Callback<DataMahasiswaDetail>() {
                        ...
                        public void onResponse(Call<DataMahasiswaDetail> call, Response<DataMahasiswaDetail> response) {
                            ...
                            txtPopupNbi.setText(response.body().getNbi_mahasiswa());
