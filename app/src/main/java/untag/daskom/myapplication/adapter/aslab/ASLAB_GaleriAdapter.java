...
import untag.daskom.myapplication.activity.aslab.ASLABHomeGaleri;
...
public class ASLAB_GaleriAdapter extends RecyclerView.Adapter<ASLAB_GaleriAdapter.ASLAB_GaleriViewHolder> {
    ...
    public ASLAB_GaleriAdapter(ArrayList<GaleriModel> galeriList, Context context) {
        this.galeriList = galeriList;
        this.context = context;
    }

    @Override
    public ASLAB_GaleriViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.single_view_row_galeri_auth,parent,false);
        return new  ASLAB_GaleriViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ASLAB_GaleriViewHolder holder, int position) {
...
//        holder.gambar.setImageBitmap(decodeImage);
    ...
    class ASLAB_GaleriViewHolder extends RecyclerView.ViewHolder {
...
//                                                    Log.d("message",message);
                                            ...
                                            Intent intent = new Intent(context, ASLABHomeGaleri.class);
