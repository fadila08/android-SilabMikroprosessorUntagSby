...
public class DOSBIM_GaleriAdapter extends RecyclerView.Adapter<DOSBIM_GaleriAdapter.DOSBIM_GaleriViewHolder> {
    ...
    public DOSBIM_GaleriAdapter(ArrayList<GaleriModel> galeriList, Context context) {
        this.galeriList = galeriList;
        this.context = context;
    }

    @Override
    public DOSBIM_GaleriViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.single_view_row_galeri,parent,false);
        return new  DOSBIM_GaleriViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DOSBIM_GaleriViewHolder holder, int position) {
...
//        holder.gambar.setImageBitmap(decodeImage);
    ...
    class DOSBIM_GaleriViewHolder extends RecyclerView.ViewHolder{
        TextView txtId, txtJudul;
        ImageView gambar;

        DOSBIM_GaleriViewHolder(View itemView) {
            super(itemView);
