...
public class DOSBIMDataMahasiswa extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_data_mahasiswa_dosbim);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_data_mahasiswa_dosbim);
...
//            startActivity(intent);
            ...
            new LogOut(DOSBIMDataMahasiswa.this);

            Intent intent = new Intent(DOSBIMDataMahasiswa.this, MainActivityLogin.class);
            startActivity(intent);
        }
