...
public class DOSBIMDetilPengumuman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dosbimdetil_pengumuman);

        txtJudul = findViewById(R.id.txt_judul_pengumuman_dosbim);
        txtCreatedat = findViewById(R.id.txt_created_at_pengumuman_dosbim);
        txtIsi = findViewById(R.id.txt_isi_pengumuman_dosbim);
        txtFileLampiran = findViewById(R.id.txt_file_lampiran_dosbim);
        ...
        call.enqueue(new Callback<PengumumanDetailList>() {
            ...
            public void onFailure(Call<PengumumanDetailList> call, Throwable t) {
                Toast.makeText(DOSBIMDetilPengumuman.this,"Something went wrong.....Error message : " + t.getMessage(), Toast.LENGTH_SHORT
                ).show();
