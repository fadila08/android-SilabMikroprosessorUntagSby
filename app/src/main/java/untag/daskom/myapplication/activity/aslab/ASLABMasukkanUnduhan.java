...
public class ASLABMasukkanUnduhan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aslabmasukkan_unduhan);

        etJudul = findViewById(R.id.add_judul_unduhan_aslab);
        etKet = findViewById(R.id.add_ket_unduhan_aslab);
        etTglBerlaku = findViewById(R.id.add_tgl_berlaku_unduhan_aslab);
        txtNamaFile = findViewById(R.id.txt_nama_file_unduhan_aslab);
        btUploadFile = findViewById(R.id.btn_pilih_file_unduhan_aslab);
        btSimpan = findViewById(R.id.bt_simpan_pengumuman_aslab);
                ...
                call.enqueue(new Callback<UnduhanDetailList>() {
                    ...
                    public void onResponse(Call<UnduhanDetailList> call, Response<UnduhanDetailList> response) {
                        ...
                        try{
                            ...
                            Toast.makeText(ASLABMasukkanUnduhan.this,"Data Berhasil Ditambahkan",Toast.LENGTH_SHORT).show();
                            //intent
                            Intent intent = new Intent(ASLABMasukkanUnduhan.this, ASLABHomeUnduhan.class);
...
//
                    ...
                    public void onFailure(Call<UnduhanDetailList> call, Throwable t) {
                        Toast.makeText(ASLABMasukkanUnduhan.this, "Something went wrong....Error message: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
