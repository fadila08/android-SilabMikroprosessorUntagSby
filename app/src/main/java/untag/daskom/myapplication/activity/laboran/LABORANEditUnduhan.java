...
public class LABORANEditUnduhan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laboranedit_unduhan);

        etJudul = findViewById(R.id.edit_judul_unduhan_laboran);
        etKet = findViewById(R.id.edit_ket_unduhan_laboran);
        etBatasBerlaku = findViewById(R.id.edit_tgl_berlaku_unduhan_laboran);
        txtFile = findViewById(R.id.txt_edit_nama_file_unduhan_laboran);
        btPilihFile = findViewById(R.id.btn_edit_file_unduhan_laboran);
        Simpan = findViewById(R.id.bt_simpan_edit_pengumuman_laboran);
...
//                }
            ...
            public void onFailure(Call<UnduhanDetailList> call, Throwable t) {
                Toast.makeText(LABORANEditUnduhan.this,"Something went wrong.....Error message : " + t.getMessage(), Toast.LENGTH_SHORT
                ).show();
                ...
                call.enqueue(new Callback<UnduhanDetailList>() {
                    ...
                    public void onResponse(Call<UnduhanDetailList> call, Response<UnduhanDetailList> response) {
                        ...
                        try{
                            ...
                            Toast.makeText(LABORANEditUnduhan.this,"Data Berhasil Diedit",Toast.LENGTH_SHORT).show();
                            //intent
                            Intent intent = new Intent(LABORANEditUnduhan.this, LABORANHomeUnduhan.class);
                    ...
                    @Override
                    public void onFailure(Call<UnduhanDetailList> call, Throwable t) {
                        Toast.makeText(LABORANEditUnduhan.this, "Something went wrong....Error message: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
