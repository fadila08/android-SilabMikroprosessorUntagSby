...
public class ASLABEditUnduhan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aslabedit_unduhan);

        etJudul = findViewById(R.id.edit_judul_unduhan_aslab);
        etKet = findViewById(R.id.edit_ket_unduhan_aslab);
        etBatasBerlaku = findViewById(R.id.edit_tgl_berlaku_unduhan_aslab);
        txtFile = findViewById(R.id.txt_edit_nama_file_unduhan_aslab);
        btPilihFile = findViewById(R.id.btn_edit_file_unduhan_aslab);
        Simpan = findViewById(R.id.bt_simpan_edit_pengumuman_aslab);
...
//                }
            ...
            public void onFailure(Call<UnduhanDetailList> call, Throwable t) {
                Toast.makeText(ASLABEditUnduhan.this,"Something went wrong.....Error message : " + t.getMessage(), Toast.LENGTH_SHORT
                ).show();
                ...
                call.enqueue(new Callback<UnduhanDetailList>() {
                    ...
                    public void onResponse(Call<UnduhanDetailList> call, Response<UnduhanDetailList> response) {
                        ...
                        try{
                            ...
                            Toast.makeText(ASLABEditUnduhan.this,"Data Berhasil Diedit",Toast.LENGTH_SHORT).show();
                            //intent
                            Intent intent = new Intent(ASLABEditUnduhan.this, ASLABHomeUnduhan.class);
                    ...
                    @Override
                    public void onFailure(Call<UnduhanDetailList> call, Throwable t) {
                        Toast.makeText(ASLABEditUnduhan.this, "Something went wrong....Error message: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
