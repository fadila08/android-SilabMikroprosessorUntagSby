...
public class KALABDetilPengumuman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalabdetil_pengumuman);

        txtJudul = findViewById(R.id.txt_judul_pengumuman_kalab);
        txtCreatedat = findViewById(R.id.txt_created_at_pengumuman_kalab);
        txtIsi = findViewById(R.id.txt_isi_pengumuman_kalab);
        txtFileLampiran = findViewById(R.id.txt_file_lampiran_kalab);
        ...
        call.enqueue(new Callback<PengumumanDetailList>() {
            ...
            public void onFailure(Call<PengumumanDetailList> call, Throwable t) {
                Toast.makeText(KALABDetilPengumuman.this,"Something went wrong.....Error message : " + t.getMessage(), Toast.LENGTH_SHORT
                ).show();
