...
public class LABORANEditDataAslab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laboranedit_data_aslab);

        etNama = findViewById(R.id.etnama_edit_aslab_laboran);
        etNomorInduk = findViewById(R.id.etnip_edit_aslab_laboran);
        etWa = findViewById(R.id.etwa_edit_aslab_laboran);
        etEmail = findViewById(R.id.etemail_edit_aslab_laboran);
        btEdit = findViewById(R.id.bteditaslab_laboran);
                ...
                call.enqueue(new Callback<UserDetailList>() {
                    ...
                    public void onResponse(Call<UserDetailList> call, Response<UserDetailList> response) {
                        ...
                        try{
                            ...
                            Toast.makeText(LABORANEditDataAslab.this,"Data Berhasil Diedit",Toast.LENGTH_SHORT).show();
                            //intent
                            Intent intent = new Intent(LABORANEditDataAslab.this, LABORANDataAslab.class);
                    ...
                    public void onFailure(Call<UserDetailList> call, Throwable t) {
                        Toast.makeText(LABORANEditDataAslab.this, "Something went wrong....Error message: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
