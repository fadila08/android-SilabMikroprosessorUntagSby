...
//            startActivity(intent);
            ...
            Intent intent = new Intent(HomeMahasiswa.this, MHSStrukturOrganisasi.class);
            intent.putExtra("nama", nama);
            startActivity(intent);

        } else if (id == R.id.nav_pengumuman_mhs) {
            Intent intent = new Intent(HomeMahasiswa.this, MHSPengumuman.class);
            intent.putExtra("nama", nama);
            startActivity(intent);

        } else if (id == R.id.nav_unduhan_mhs) {
            Intent intent = new Intent(HomeMahasiswa.this, MHSHomeUnduhan.class);
            intent.putExtra("nama", nama);
            startActivity(intent);

        } else if (id == R.id.nav_galeri_mhs) {
            Intent intent = new Intent(HomeMahasiswa.this, MHSHomeGaleri.class);
            intent.putExtra("nama",nama);
            startActivity(intent);
