...
public class LABORANMasukkanUnduhan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laboranmasukkan_unduhan);

        etJudul = findViewById(R.id.add_judul_unduhan_laboran);
        etKet = findViewById(R.id.add_ket_unduhan_laboran);
        etTglBerlaku = findViewById(R.id.add_tgl_berlaku_unduhan_laboran);
        txtNamaFile = findViewById(R.id.txt_nama_file_unduhan_laboran);
        btUploadFile = findViewById(R.id.btn_pilih_file_unduhan_laboran);
        btSimpan = findViewById(R.id.bt_simpan_pengumuman_laboran);
                ...
                call.enqueue(new Callback<UnduhanDetailList>() {
                    ...
                    public void onResponse(Call<UnduhanDetailList> call, Response<UnduhanDetailList> response) {
                        ...
                        try{
                            ...
                            Toast.makeText(LABORANMasukkanUnduhan.this,"Data Berhasil Ditambahkan",Toast.LENGTH_SHORT).show();
                            //intent
                            Intent intent = new Intent(LABORANMasukkanUnduhan.this, LABORANHomeUnduhan.class);
...
//
                    ...
                    public void onFailure(Call<UnduhanDetailList> call, Throwable t) {
                        Toast.makeText(LABORANMasukkanUnduhan.this, "Something went wrong....Error message: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
