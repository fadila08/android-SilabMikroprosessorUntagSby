...
public class KALABMasukkanGaleri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalabmasukkan_galeri);

        etJudul = findViewById(R.id.add_judul_gambar_kalab);
        txtNamaGambar = findViewById(R.id.txt_gambar_kalab);
        btUploadGambar = findViewById(R.id.bt_upload_gbr_kalab);
        btSimpan = findViewById(R.id.simpan_gambar_kalab);
        ...
        btSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<GaleriDetailList> call = service.addGaleri("bearer "+session,
                        ...
                        gambar); //gambarnya belom ketangkep
                ...
                call.enqueue(new Callback<GaleriDetailList>() {
                    ...
                    public void onResponse(Call<GaleriDetailList> call, Response<GaleriDetailList> response) {
                        ...
                        try{
                            ...
                            Toast.makeText(KALABMasukkanGaleri.this,"Data Berhasil Ditambahkan",Toast.LENGTH_SHORT).show();
                            //intent
                            Intent intent = new Intent(KALABMasukkanGaleri.this, KALABHomeGaleri.class);
...
//
                    ...
                    public void onFailure(Call<GaleriDetailList> call, Throwable t) {
                        Toast.makeText(KALABMasukkanGaleri.this, "Something went wrong....Error message: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
