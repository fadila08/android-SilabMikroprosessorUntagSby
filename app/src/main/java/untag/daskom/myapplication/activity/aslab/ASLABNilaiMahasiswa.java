...
import untag.daskom.myapplication.adapter.aslab.ASLAB_DataNilaiMahasiswaAdapter;
...
public class ASLABNilaiMahasiswa extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_nilai_mahasiswa_aslab);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_nilai_mahasiswa_aslab);
        ...
        call.enqueue(new Callback<DataUserList>() {
            ...
            public void onFailure(Call<DataUserList> call, Throwable t) {
                Toast.makeText(ASLABNilaiMahasiswa.this, "Something went wrong....Error message: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        //sampai sini
    }
...
//            startActivity(intent);
            ...
            Intent intent = new Intent(ASLABNilaiMahasiswa.this, ASLABHomeProfil.class);
            intent.putExtra("nama",nama_aslab);
            startActivity(intent);

        } else if (id == R.id.nav_struktur_aslab) {
            Intent intent = new Intent(ASLABNilaiMahasiswa.this, ASLABStrukturOrganisasi.class);
            intent.putExtra("nama",nama_aslab);
            startActivity(intent);
            ...
            Intent intent = new Intent(ASLABNilaiMahasiswa.this, ASLABHomeUnduhan.class);
            intent.putExtra("nama",nama_aslab);
            startActivity(intent);

        } else if (id == R.id.nav_galeri_aslab) {
            Intent intent = new Intent(ASLABNilaiMahasiswa.this, ASLABHomeGaleri.class);
            intent.putExtra("nama", nama_aslab);
            startActivity(intent);

        } else if (id == R.id.nav_logout_aslab) {
            new LogOut(ASLABNilaiMahasiswa.this);

            Intent intent = new Intent(ASLABNilaiMahasiswa.this, MainActivityLogin.class);
            startActivity(intent);
        }
    ...
    private void generateDataUserList(ArrayList<DataUser> dataUserArrayList) {
        recyclerView = findViewById(R.id.rv_nilai_mahasiswa_aslab);
        adapter = new ASLAB_DataNilaiMahasiswaAdapter(dataUserArrayList);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ASLABNilaiMahasiswa.this);
